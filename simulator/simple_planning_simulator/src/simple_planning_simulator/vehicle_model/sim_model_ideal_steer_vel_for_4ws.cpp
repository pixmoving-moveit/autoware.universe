...
#include "simple_planning_simulator/vehicle_model/sim_model_ideal_steer_vel_for_4ws.hpp"

SimModelIdealSteerVelFor4WS::SimModelIdealSteerVelFor4WS(double wheelbase)
: SimModelInterface(3 /* dim x */, 2 /* dim u */), wheelbase_(wheelbase)
{
}

double SimModelIdealSteerVelFor4WS::getX() { return state_(IDX::X); }
double SimModelIdealSteerVelFor4WS::getY() { return state_(IDX::Y); }
double SimModelIdealSteerVelFor4WS::getYaw() { return state_(IDX::YAW); }
double SimModelIdealSteerVelFor4WS::getVx() { return input_(IDX_U::VX_DES); }
double SimModelIdealSteerVelFor4WS::getVy() { return 0.0; }
...
Eigen::VectorXd SimModelIdealSteerVelFor4WS::calcModel(
