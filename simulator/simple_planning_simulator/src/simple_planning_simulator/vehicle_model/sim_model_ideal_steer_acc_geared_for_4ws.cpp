...
#include "simple_planning_simulator/vehicle_model/sim_model_ideal_steer_acc_geared_for_4ws.hpp"

#include "autoware_auto_vehicle_msgs/msg/gear_command.hpp"

#include <algorithm>

SimModelIdealSteerAccGearedFor4WS::SimModelIdealSteerAccGearedFor4WS(double wheelbase)
: SimModelInterface(4 /* dim x */, 2 /* dim u */), wheelbase_(wheelbase), current_acc_(0.0)
{
}

double SimModelIdealSteerAccGearedFor4WS::getX()
{
  return state_(IDX::X);
}
double SimModelIdealSteerAccGearedFor4WS::getY()
{
  return state_(IDX::Y);
}
double SimModelIdealSteerAccGearedFor4WS::getYaw()
{
  return state_(IDX::YAW);
}
double SimModelIdealSteerAccGearedFor4WS::getVx()
{
  return state_(IDX::VX);
}
double SimModelIdealSteerAccGearedFor4WS::getVy()
{
  return 0.0;
}
double SimModelIdealSteerAccGearedFor4WS::getAx()
{
  return current_acc_;
}
...
void SimModelIdealSteerAccGearedFor4WS::update(const double & dt)
{
...
Eigen::VectorXd SimModelIdealSteerAccGearedFor4WS::calcModel(
...
void SimModelIdealSteerAccGearedFor4WS::updateStateWithGear(
