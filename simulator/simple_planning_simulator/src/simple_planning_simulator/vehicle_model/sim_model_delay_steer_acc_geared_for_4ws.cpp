...
#include "simple_planning_simulator/vehicle_model/sim_model_delay_steer_acc_geared_for_4ws.hpp"

#include "autoware_auto_vehicle_msgs/msg/gear_command.hpp"

#include <algorithm>

SimModelDelaySteerAccGearedFor4WS::SimModelDelaySteerAccGearedFor4WS(
...
double SimModelDelaySteerAccGearedFor4WS::getX()
{
  return state_(IDX::X);
}
double SimModelDelaySteerAccGearedFor4WS::getY()
{
  return state_(IDX::Y);
}
double SimModelDelaySteerAccGearedFor4WS::getYaw()
{
  return state_(IDX::YAW);
}
double SimModelDelaySteerAccGearedFor4WS::getVx()
{
  return state_(IDX::VX);
}
double SimModelDelaySteerAccGearedFor4WS::getVy()
{
  return 0.0;
}
double SimModelDelaySteerAccGearedFor4WS::getAx()
{
  return state_(IDX::ACCX);
}
double SimModelDelaySteerAccGearedFor4WS::getWz()
{
  return 2 * state_(IDX::VX) * std::tan(state_(IDX::STEER)) / wheelbase_;
}
double SimModelDelaySteerAccGearedFor4WS::getSteer()
{
  return state_(IDX::STEER);
}
void SimModelDelaySteerAccGearedFor4WS::update(const double & dt)
{
...
void SimModelDelaySteerAccGearedFor4WS::initializeInputQueue(const double & dt)
{
...
Eigen::VectorXd SimModelDelaySteerAccGearedFor4WS::calcModel(
  const Eigen::VectorXd & state, const Eigen::VectorXd & input)
{
  ...
  d_state(IDX::YAW) = 2 * vel * std::tan(steer) / wheelbase_;
  d_state(IDX::VX) = acc;
...
void SimModelDelaySteerAccGearedFor4WS::updateStateWithGear(
