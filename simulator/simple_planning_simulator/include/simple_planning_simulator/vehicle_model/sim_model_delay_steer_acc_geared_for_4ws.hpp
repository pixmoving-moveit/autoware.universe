...
#ifndef SIMPLE_PLANNING_SIMULATOR__VEHICLE_MODEL__SIM_MODEL_DELAY_STEER_ACC_GEARED_FOR_4WS_HPP_
#define SIMPLE_PLANNING_SIMULATOR__VEHICLE_MODEL__SIM_MODEL_DELAY_STEER_ACC_GEARED_FOR_4WS_HPP_
...
class SimModelDelaySteerAccGearedFor4WS : public SimModelInterface
{
public:
  /**
   * @brief constructor
   ...
   */
  SimModelDelaySteerAccGearedFor4WS(
   ...
   */
  ~SimModelDelaySteerAccGearedFor4WS() = default;
...
#endif  // SIMPLE_PLANNING_SIMULATOR__VEHICLE_MODEL__SIM_MODEL_DELAY_STEER_ACC_GEARED_FOR_4WS_HPP_
