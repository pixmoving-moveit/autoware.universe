...
#ifndef SIMPLE_PLANNING_SIMULATOR__VEHICLE_MODEL__SIM_MODEL_IDEAL_STEER_ACC_GEARED_FOR_4WS_HPP_
#define SIMPLE_PLANNING_SIMULATOR__VEHICLE_MODEL__SIM_MODEL_IDEAL_STEER_ACC_GEARED_FOR_4WS_HPP_
...
/**
 * @class SimModelIdealSteerAccGearedFor4WS
 * @brief calculate ideal steering dynamics
 */
class SimModelIdealSteerAccGearedFor4WS : public SimModelInterface
{
public:
  /**
   * @brief constructor
   ...
   */
  explicit SimModelIdealSteerAccGearedFor4WS(double wheelbase);

  /**
   * @brief destructor
   */
  ~SimModelIdealSteerAccGearedFor4WS() = default;
...
#endif  // SIMPLE_PLANNING_SIMULATOR__VEHICLE_MODEL__SIM_MODEL_IDEAL_STEER_ACC_GEARED_FOR_4WS_HPP_
