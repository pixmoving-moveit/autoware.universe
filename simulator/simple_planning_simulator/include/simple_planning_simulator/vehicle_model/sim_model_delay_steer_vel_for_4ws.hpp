...
#ifndef SIMPLE_PLANNING_SIMULATOR__VEHICLE_MODEL__SIM_MODEL_DELAY_STEER_VEL_FOR_4WS_HPP_
#define SIMPLE_PLANNING_SIMULATOR__VEHICLE_MODEL__SIM_MODEL_DELAY_STEER_VEL_FOR_4WS_HPP_
 ...
 */
class SimModelDelaySteerVelFor4WS : public SimModelInterface
{
public:
  /**
   * @brief constructor
   ...
   * @brief destructor
   */
  ~SimModelDelaySteerVelFor4WS() = default;
...
#endif  // SIMPLE_PLANNING_SIMULATOR__VEHICLE_MODEL__SIM_MODEL_DELAY_STEER_VEL_FOR_4WS_HPP_
