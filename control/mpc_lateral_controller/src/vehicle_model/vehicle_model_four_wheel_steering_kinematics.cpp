...
#include "mpc_lateral_controller/vehicle_model/vehicle_model_four_wheel_steering_kinematics.hpp"

#include <cmath>

namespace autoware::motion::control::mpc_lateral_controller
{
KinematicsFourWheelSteeringModel::KinematicsFourWheelSteeringModel(
...
void KinematicsFourWheelSteeringModel::calculateDiscreteMatrix(
  ...
  const double dt)
{
  ...
  a_d << 0.0, velocity, 0.0, 0.0, 0.0, 2 * velocity / m_wheelbase * cos_delta_r_squared_inv, 0.0,
    0.0, -1.0 / m_steer_tau;
  ...
  w_d << 0.0,
    -velocity * m_curvature +
      2 * velocity / m_wheelbase * (tan(delta_r) - delta_r * cos_delta_r_squared_inv),
    0.0;
...
void KinematicsFourWheelSteeringModel::calculateReferenceInput(Eigen::MatrixXd & u_ref)
{
