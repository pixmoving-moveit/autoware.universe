 ...
 *         [0,  vr,                     0]       [    0]       [                             0]
 * dx/dt = [0,   0, 2*vr/W/cos(steer_r)^2] * x + [    0] * u + [-2*vr*steer_r/W/cos(steer_r)^2]
 *         [0,   0,                 1/tau]       [1/tau]       [              s              0]
 *
 */

#ifndef MPC_LATERAL_CONTROLLER__VEHICLE_MODEL__VEHICLE_MODEL_FOUR_WHEEL_STEERING_KINEMATICS_HPP_
#define MPC_LATERAL_CONTROLLER__VEHICLE_MODEL__VEHICLE_MODEL_FOUR_WHEEL_STEERING_KINEMATICS_HPP_
...
/**
 * Vehicle model class of four wheel steering kinematics
 * @brief calculate model-related values
 */
class KinematicsFourWheelSteeringModel : public VehicleModelInterface
{
public:
  /**
   ...
   */
  KinematicsFourWheelSteeringModel(const double wheelbase, const double steer_lim, const double steer_tau);

  /**
   * @brief destructor
   */
  ~KinematicsFourWheelSteeringModel() = default;
  ...
  std::string modelName() override { return "kinematics_4ws"; };
...
#endif  // MPC_LATERAL_CONTROLLER__VEHICLE_MODEL__VEHICLE_MODEL_FOUR_WHEEL_STEERING_KINEMATICS_HPP_
